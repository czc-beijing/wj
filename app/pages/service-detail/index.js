...
Page({
    ...
    async handleUpdateService() {
        const newData = JSON.stringify(this.data.service);
        wx.navigateTo({
            url: `/pages/service-management/index?service=` + encodeURIComponent(newData)
        })
    },
    ...
    handleOrder() {
        ...
        const newData = JSON.stringify(this.data.service);
        wx.navigateTo({
            url: `/pages/order/index?service=`+ encodeURIComponent(newData)
        })
    },
